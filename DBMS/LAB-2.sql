...
--12
SELECT CNAME, BANME AS BNAME FROM DEPOSIT WHERE AMOUNT>4000 AND ACTNO<105 

--13
SELECT * FROM BORROW WHERE AMOUNT BETWEEN 3000 AND 8000

--14
SELECT * FROM DEPOSIT WHERE BANME <> 'ANDHERI'

--15
SELECT ACTNO, CNAME ,AMOUNT FROM DEPOSIT WHERE BANME IN ('AJNI','KAROLBAGH','M.G.ROAD') AND ACTNO<104
