...
SELECT * FROM STUDENT;
UPDATE STUDENT 
SET ADRESS = '"Ram Krupa" , Raiya Road'
WHERE STUID = 1022;

--1. Display the name of students whose name starts with ‘k’.
	SELECT FIRSTNAME FROM STUDENT WHERE FIRSTNAME LIKE 'H%';
...
--10. Display all the name students having websites.
	SELECT FIRSTNAME FROM STUDENT WHERE NOT WEBSITE IS NULL;
...
--1. Display all the students whose address consist of -.
	SELECT * FROM STUDENT WHERE ADRESS LIKE '%-%';
--2. Display all the students whose address contains single quote or double quote.
	SELECT * FROM STUDENT WHERE ADRESS LIKE '%"%"%' or ADRESS LIKE '%''%''%';
